...
**Alumno:** Benjamin Juan Miles Rouillon
---
...
9. Si el número existe en el arreglo, mostrar el mensaje:

   **"Numero encontrado"**

10. Si el número no existe en el arreglo, mostrar el mensaje:
...
| Archivo             | Descripción                                                                 |
|---------------------|-----------------------------------------------------------------------------|
| `algoritmo.py`      | Implementación del algoritmo: carga de números, ordenamiento Burbuja y Búsqueda Binaria |
| `test_algoritmo.py` | Pruebas unitarias con `pytest` para las funciones de ordenamiento y búsqueda |
